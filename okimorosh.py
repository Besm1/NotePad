...
def about():
    showinfo("About", "This is a basic text editor done in python by Moses 2023")
...
size_box = Spinbox(frame, from_=1, to=50, textvariable=font_size, command=change_font)
